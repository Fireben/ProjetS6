...
public class ExerciceEditView extends ViewImpl implements
		ExerciceEditPresenter.MyView {
	...
	public interface Binder extends UiBinder<Widget, ExerciceEditView> {

	}

	@Inject
	public ExerciceEditView(final Binder binder) {
	...
	public void setInSlot(Object slot, Widget content) {
		if (slot == ExerciceEditPresenter.SLOT_confirm) {
			confirmPanel.clear();
			if (content != null)
