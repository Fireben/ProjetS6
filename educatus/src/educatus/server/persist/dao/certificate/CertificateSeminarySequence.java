...
public class CertificateSeminarySequence extends CertificateSequence implements
		Serializable {
	...
	public void setCertificateSeminarySequencePK(
			CertificateSeminarySequencePK id) {
